...
{
    /// <summary>
    /// Minecraft Console Client by Anomalya (c) 2021.
    ...
    static class Program
    {
        ...
        {
            Console.WriteLine("Anomalya Client for MC {0} to {1} - v{2} - By Anomalya Corp", MCLowestVersion, MCHighestVersion, Version);
